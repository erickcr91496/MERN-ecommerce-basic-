...
const initialState = {
    ...
    title: '',
    price: 0,
    description: 'How to and tutorial videos of cool CSS effect, Web design ideas, JavasCript libreries, NOde.',
    content: 'Welcome to out chanelDev At. Here yo can Learn web disgning, ui/ux designing, htmal, css, totials, css animations',
    category: '' ,
    _id: ''
}
    ...
    const handleUpload = async e =>{
        ...
        try {
            ...
            if(file.type !== 'image/jpeg' && file.type !== 'image/png') // 
                return alert('File formar is incorrec.!')
        ...
        <div className="create_product">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="row">
                    ...
                    <textarea type="text" name="description" id="price" required value={product.description} rows="5" onChange={handleChangeInput} />
                </div>
                ...
                <div className="row">
                    ...
                    <select name="category"  value={product.category}onChange={handleChangeInput}>
                        <option value="">Please a select a category</option>
                        {
